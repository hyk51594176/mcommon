      ...
      if (this.list.length) {
        if (!this.multiple) {
          this.currentValue !== null &&
            ...
            this.currentValue !== "" &&
            !this.list.some(
              obj => obj[this.valueKey.value] === this.currentValue
            ) &&
            (this.currentValue = null);
        } else {
          this.currentValue &&
            this.currentValue.length &&
            (this.currentValue = this.currentValue.filter(id =>
              this.list.some(obj => obj[this.valueKey.value] === id)
            ));
        }
      } else {
        if (this.multiple) {
    ...
    getCurrentObj() {
      ...
      if (!this.multiple) {
        if (!this.currentValue) {
          ...
          currentObj =
            this.list.find(obj => obj[key] === this.currentValue) || {};
        }
      } else {
        currentObj = [];
